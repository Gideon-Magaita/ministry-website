...
import MainLayout from './components/pages/users/layout/MainLayout'
import AdminMainLayout from './components/pages/admins/layout/MainLayout'
...
export default function App() {
  return <Routes>
    ...
    <Route path="/admin" element={<AdminMainLayout />}>
      ...
      <Route path="*" element={<div className="py-5">
        <h2>Admin page coming soon</h2>
        <p className="text-muted">This module is ready to be connected to the CMS API.</p>
        </div>} 
        />
    </Route>
    <Route path="*" element={
